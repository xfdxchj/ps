...
public class FireDragon extends Boss implements Callback {
    ...
    public void damage(int dmg, Object src) {
        ...
        super.damage(dmg, src); //END(port): 去掉 DamageType
    }
    ...
    public void die( Object cause ) {
        ...
        if(noAlive){
            ...
            Dungeon.level.drop( new DragonShiled().upgrade(), pos ).sprite.drop();

            /*END(port): GetBossLoot 未搬*/
            ...
            if(!Statistics.bossRushMode){
                ...
                Ankh item = new Ankh();
                /*END(port): Ankh.blessed 为 private，省略*/
            ...
            for (ClearCryStal w : clearCryStals.toArray(new ClearCryStal[0])){
                ...
                /*END(port): quantity 为 protected，省略*/
            }
