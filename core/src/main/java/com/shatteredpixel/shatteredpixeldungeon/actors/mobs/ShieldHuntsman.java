                ...
                case 0:
                    if (weapon != null) {
                        ...
                        if (--hitsToDisarm == 0) {
                            ...
                            GLog.n(Messages.get(this, "disarm", weapon.name()));
                    ...
                    if(armor != null){
                        ...
                        if (--hitsToDisarm == 0) {
                            ...
                            Item.updateQuickslot();
                            GLog.n(Messages.get(this, "disarm", armor.name()));
                    ...
                    if (misc != null) {
                        ...
                        if (--hitsToDisarm == 0) {
                            ...
                            Item.updateQuickslot();
                            GLog.n(Messages.get(this, "disarm", misc.name()));
