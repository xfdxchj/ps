...
public class ClearElemtGuard extends Statue {
    ...
    protected boolean act() {
        ...
        if (clearCount>=2 || true /*END(port): Conducts 未搬*/) {
            state = HUNTING;
        } else {
            state = PASSIVE;
    ...
    public void die( Object cause ) {
        ...
        /*END(port): ClearElemtGuardNPC 未搬*/ Mob mob = null;
    ...
    public void cleanse(){
        if(clearCount>=2){
            ...
            Dungeon.hero.sprite.parent.add(new Delayer(1f){
                @Override
