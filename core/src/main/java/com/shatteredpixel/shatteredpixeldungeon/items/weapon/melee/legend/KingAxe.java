...
public class KingAxe extends MeleeWeapon implements Item.LengedsItem {
    ...
    public static void heavyBlowAbility(Hero hero, Integer target, float dmgMulti, MeleeWeapon wep){
        ...
        hero.sprite.attack(enemy.pos, new Callback() {
            @Override
            public void call() {
                //END(移植调整): beforeAbilityUsed 为 protected，省略
                ...
                //END(移植调整): afterAbilityUsed 为 protected，省略

                //END(移植调整): 省略 DwarfSolider 援军召唤（依赖未搬的 DwarfSolider/WandOfAnmy）
            }
        });
    }
