...
public class MorphsGodEndTheaterPlot extends Plot {
    ...
    private void process_to_Select()
    {
        ...
        Select_A_Button.setRect(diagulewindow.thirdAvatar.x - diagulewindow.rightname.width(),0 /*END(裁剪): chrome 为 protected*/,20,16);
        ...
        Select_B_Button.setRect(diagulewindow.thirdAvatar.x + diagulewindow.rightname.width(),0 /*END(裁剪): chrome 为 protected*/,20,16);
    ...
    {
        if(true) { //END(裁剪): Conducts 未搬
            Badges.validateVictory();
            /*END(裁剪): PaswordBadges 未搬，省略成就*/
