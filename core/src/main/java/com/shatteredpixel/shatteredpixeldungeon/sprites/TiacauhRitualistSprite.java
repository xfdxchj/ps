//END(port from Arknights): TiacauhRitualistSprite
...
public class TiacauhRitualistSprite
extends MobSprite {
    public TiacauhRitualistSprite() {
        this.texture("sprites/tiacauh_ritualist.png");
    ...
    public void zap(int cell) {
        ...
        MagicMissile.boltFromChar(this.parent, 12, this, cell, new Callback(){
            ...
            @Override
            public void call() {
                ((TiacauhRitualist)TiacauhRitualistSprite.this.ch).onZapComplete();
            }
        });
