...
public class Assets {
	...
	public static class Music {
		...
		//END(用户指定): 六天王用【方舟主线】(1-5 章) 的音乐：
		//   六个王  -> boss.ogg / boss2~boss5.ogg（主线 Boss 曲）+ boss_kalt（关底）
		//   NPC 层  -> theme.ogg（主线标题曲，平静，适合叙事）
		public static final String SIXKINGS_GUIDE = "music/theme.ogg";          //26F 引路人之厅（平静）
		...
		public static final String SIXKINGS_FINAL = "music/boss_kalt.ogg";      //32F 全能王（关底）
